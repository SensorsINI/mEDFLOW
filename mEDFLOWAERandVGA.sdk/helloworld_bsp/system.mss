...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = EVABMOFStreamWithControl
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = EVABMOFStreamWithCon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = EVMUXDataToXYTSStream
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = EVMUXDataToXYTSStream_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SFAST_process_data
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SFAST_process_data_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = eventStreamToConstEncntFrameStream
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = eventStreamToConstEn_0
END
