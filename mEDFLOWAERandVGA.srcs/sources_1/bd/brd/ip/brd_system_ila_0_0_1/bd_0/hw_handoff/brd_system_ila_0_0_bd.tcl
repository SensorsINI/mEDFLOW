...
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_ports SLOT_2_AXI] [get_bd_intf_pins g_inst/slot_2_axi]
  ...
  connect_bd_net -net net_slot_1_axis_tdata [get_bd_pins g_inst/m_slot_1_axis_tdata] [get_bd_pins ila_lib/probe15]
  ...
  connect_bd_net -net net_slot_2_axi_ar_cnt [get_bd_pins g_inst/m_slot_2_axi_ar_cnt] [get_bd_pins ila_lib/probe19]
  connect_bd_net -net net_slot_2_axi_ar_ctrl [get_bd_pins ila_lib/probe47] [get_bd_pins slot_2_ar/dout]
  connect_bd_net -net net_slot_2_axi_araddr [get_bd_pins g_inst/m_slot_2_axi_araddr] [get_bd_pins ila_lib/probe20]
  connect_bd_net -net net_slot_2_axi_arburst [get_bd_pins g_inst/m_slot_2_axi_arburst] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_2_axi_arcache [get_bd_pins g_inst/m_slot_2_axi_arcache] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net net_slot_2_axi_arlen [get_bd_pins g_inst/m_slot_2_axi_arlen] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_2_axi_arlock [get_bd_pins g_inst/m_slot_2_axi_arlock] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net net_slot_2_axi_arprot [get_bd_pins g_inst/m_slot_2_axi_arprot] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_2_axi_arqos [get_bd_pins g_inst/m_slot_2_axi_arqos] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_2_axi_arready [get_bd_pins g_inst/m_slot_2_axi_arready] [get_bd_pins slot_2_ar/In1]
  connect_bd_net -net net_slot_2_axi_arsize [get_bd_pins g_inst/m_slot_2_axi_arsize] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_2_axi_arvalid [get_bd_pins g_inst/m_slot_2_axi_arvalid] [get_bd_pins slot_2_ar/In0]
  connect_bd_net -net net_slot_2_axi_aw_cnt [get_bd_pins g_inst/m_slot_2_axi_aw_cnt] [get_bd_pins ila_lib/probe28]
  connect_bd_net -net net_slot_2_axi_aw_ctrl [get_bd_pins ila_lib/probe44] [get_bd_pins slot_2_aw/dout]
  connect_bd_net -net net_slot_2_axi_awaddr [get_bd_pins g_inst/m_slot_2_axi_awaddr] [get_bd_pins ila_lib/probe29]
  connect_bd_net -net net_slot_2_axi_awburst [get_bd_pins g_inst/m_slot_2_axi_awburst] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_2_axi_awcache [get_bd_pins g_inst/m_slot_2_axi_awcache] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_2_axi_awlen [get_bd_pins g_inst/m_slot_2_axi_awlen] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_2_axi_awlock [get_bd_pins g_inst/m_slot_2_axi_awlock] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_2_axi_awprot [get_bd_pins g_inst/m_slot_2_axi_awprot] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_2_axi_awqos [get_bd_pins g_inst/m_slot_2_axi_awqos] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_2_axi_awready [get_bd_pins g_inst/m_slot_2_axi_awready] [get_bd_pins slot_2_aw/In1]
  connect_bd_net -net net_slot_2_axi_awsize [get_bd_pins g_inst/m_slot_2_axi_awsize] [get_bd_pins ila_lib/probe36]
