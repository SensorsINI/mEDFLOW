...
entity bd_13e4 is
  ...
  attribute CORE_GENERATION_INFO of bd_13e4 : entity is "bd_13e4,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_13e4,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of bd_13e4 is
  ...
  component bd_13e4_slot_2_apcs_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  end component bd_13e4_slot_2_apcs_0;
  ...
  signal net_slot_2_apc_pc_asserted : STD_LOGIC;
  ...
  signal NLW_slot_2_apcs_pc_status_UNCONNECTED : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS, ASSOCIATED_CLKEN aclken, ASSOCIATED_RESET resetn, CLK_DOMAIN brd_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000";
...
ila_lib: component bd_13e4_ila_lib_0
     port map (
      ...
      probe12(23 downto 0) => net_slot_0_axis_tdata(23 downto 0),
      probe13(0) => net_slot_0_axis_tdest(0),
      probe14(0) => net_slot_0_axis_tid(0),
      probe15(2 downto 0) => net_slot_0_axis_tkeep(2 downto 0),
      probe16(2 downto 0) => net_slot_0_axis_tstrb(2 downto 0),
      probe17(1 downto 0) => net_slot_0_axis_tuser(1 downto 0),
...
slot_2_apcs: component bd_13e4_slot_2_apcs_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
      pc_asserted => net_slot_2_apc_pc_asserted,
      pc_axis_tdata(15 downto 0) => Conn2_TDATA(15 downto 0),
      pc_axis_tready => Conn2_TREADY,
      pc_axis_tvalid => Conn2_TVALID,
      pc_status(31 downto 0) => NLW_slot_2_apcs_pc_status_UNCONNECTED(31 downto 0)
    );
end STRUCTURE;
