...
module brd_XYTSStreamToRawStream_0_0(tsReg_V_ap_vld, glLastTSReg_V_ap_vld, 
  ...
  rotateInfoOutReg_V_ap_vld, sentCnt_V_ap_vld, continousTestCnt_V_ap_vld, 
  nonMonTSDiffFlgReg_V_ap_vld, tsWrappedVal_V_ap_vld, ap_clk, ap_rst_n, ap_start, ap_done, 
  ap_idle, ap_ready, streamOut_V_V_TVALID, streamOut_V_V_TREADY, streamOut_V_V_TDATA, 
  xStreamIn_V_V_TVALID, xStreamIn_V_V_TREADY, xStreamIn_V_V_TDATA, yStreamIn_V_V_TVALID, 
  yStreamIn_V_V_TREADY, yStreamIn_V_V_TDATA, tsStreamIn_V_V_TVALID, 
  ...
  glLastYReg_V, tsDiffFlgReg_V, yDiffFlgReg_V, rotateInfoOutReg_V, sentCnt_V, 
  continousTestCnt_V, nonMonTSDiffFlgReg_V, tsWrappedVal_V)
/* synthesis syn_black_box black_box_pad_pin="tsReg_V_ap_vld,glLastTSReg_V_ap_vld,yReg_V_ap_vld,glLastYReg_V_ap_vld,tsDiffFlgReg_V_ap_vld,yDiffFlgReg_V_ap_vld,rotateInfoOutReg_V_ap_vld,sentCnt_V_ap_vld,continousTestCnt_V_ap_vld,nonMonTSDiffFlgReg_V_ap_vld,tsWrappedVal_V_ap_vld,ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,streamOut_V_V_TVALID,streamOut_V_V_TREADY,streamOut_V_V_TDATA[15:0],xStreamIn_V_V_TVALID,xStreamIn_V_V_TREADY,xStreamIn_V_V_TDATA[15:0],yStreamIn_V_V_TVALID,yStreamIn_V_V_TREADY,yStreamIn_V_V_TDATA[15:0],tsStreamIn_V_V_TVALID,tsStreamIn_V_V_TREADY,tsStreamIn_V_V_TDATA[63:0],polStreamIn_V_V_TVALID,polStreamIn_V_V_TREADY,polStreamIn_V_V_TDATA[7:0],custDataStreamIn_V_V_TVALID,custDataStreamIn_V_V_TREADY,custDataStreamIn_V_V_TDATA[15:0],tsReg_V[63:0],glLastTSReg_V[63:0],yReg_V[15:0],glLastYReg_V[15:0],tsDiffFlgReg_V[0:0],yDiffFlgReg_V[0:0],rotateInfoOutReg_V[63:0],sentCnt_V[31:0],continousTestCnt_V[15:0],nonMonTSDiffFlgReg_V[0:0],tsWrappedVal_V[11:0]" */;
