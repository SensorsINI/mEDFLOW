...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M07_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
